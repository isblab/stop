...
# Holds the details of a single command execution
class Job:
...
# Manages the execution of the commands, communicating with the outputs and following on the progress
class Executor:
...
def parse_file(filename):
    ...
    if param_mapping['analysis_wrapper'] is None:
        ...
        exec(str_to_exec)
        param_mapping['analysis_wrapper'] = eval(foo)
